...
public class QuestProgress
{
    ...
    public int pendingOptionalGold;
    public int pendingOptionalExp;
    public List<Item> pendingOptionalItems = new List<Item>();
    public List<Equipment> pendingOptionalEquipment = new List<Equipment>();
